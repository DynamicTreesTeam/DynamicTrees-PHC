...
@Mod(modid = ModConstants.MODID, name=ModConstants.NAME, dependencies=ModConstants.DEPENDENCIES, updateJSON = "https://github.com/DynamicTreesTeam/DynamicTreesVersionInfo/blob/master/Add-ons/PHC.json?raw=true")
